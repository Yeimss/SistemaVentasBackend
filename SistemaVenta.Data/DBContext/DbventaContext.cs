...
namespace SistemaVenta.Data.DBcontext;
...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C82CEA041");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F456B3E59");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483E70FB61A");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4971393BA");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421AB107D5FE");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1329F948F43");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76F4403B49");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6E56DD75B");
